...
<div className="relative w-full h-full flex justify-end bg-gradient-to-t from-black via-transparent to-black overflow-hidden">
      ...
      {/* :HERO IMAGE */}
      <img src="https://sfdc-static.blackthorn.io/00D4x000000Jt4SEAS/a2T4x000000wBq4/00N4x00000QIOHQ/0EM4x0000032nJs" alt="" className="absolute w-full h-full object-cover object-left sm:object-center opacity-70" />

      {/* :HERO MAIN CONTAINER */}
      <div className="relative py-28 xl:py-40 w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center">
        
        {/* ::Hero title & text */}
        <div className="mx-5 md:mx-0 p-8 rounded-xl md:rounded-r-none bg-primary bg-opacity-50 text-black shadow-2xl">
          <h1 className="text-3xl sm:text-5xl font-josefin font-extrabold">About the <br/><span className="text-yellow-400 text-opacity-80">ICDRET</span>  <br/>2024!</h1>
          <p className="mt-3 text-white font-firacode">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta blanditiis in asperiores optio est, id, temporibus perspiciatis ratione ipsam quam tempore aliquam distinctio repudiandae iusto facilis, consequatur eligendi illum quos.</p>
        </div>
      ...
      <div className="absolute left-1/2 bottom-0 w-full md:w-2/3 flex justify-around items-end transform -translate-x-1/2">
        {/* ::Our Story */}
        <a href="#link" className="group relative py-5 w-40 rounded-t-xl bg-primary bg-opacity-50 text-center text-white font-semibold font-firacode transition-all duration-300 transform hover:pb-14">
          Our Story
